...
static struct DS_TwoDim_BoolArr* twodim_boolarr_ctor(va_list* app) {
    ...
    int init_num_points = 0; // TODO: Testing
	...
	for (int row_index = 0; row_index < (int) init_num_rows; row_index++)
		*(cell_arr + row_index) = calloc(init_num_cols, sizeof(bool*)); // TODO: Check if this should be bool*
...
static bool** twodim_boolarr_get_cpydata(struct DS_TwoDim_BoolArr* ds_tdba) {
